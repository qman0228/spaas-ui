...
| text-color  | Couleur du texte du menu (format hexadécimal) | string |   —   | #2D303B |
| active-text-color  | Couleur du texte de l'item actif (format hexadécimal). | string |   —   | #5D81F9 |
