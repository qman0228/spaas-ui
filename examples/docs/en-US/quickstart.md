...
```javascript
import Vue from 'vue';
import ElementUI from 'spaas-ui';
import 'spaas-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'spaas-ui';
import App from './App.vue';
